var BackgroundimageCreationPanel = React.createClass({
    ...
    handleSubmit: function(e) {
        ...
        ReactDOM.render(<BackgroundimageOptionsForm src={this.state.data_uri} dimensions={this.state.dimensions} aspectratio={this.state.aspectratio}/>, document.getElementById('content-modal'));
    ...
    render: function() {
        ...
        var centerheader = {textAlign:'center'};
        return (

        <div className="container-fluid">
            <div className="row">
                <div className="col-xs-12">
                <h4 style={centerheader}>Known bug! Image uploader closes the first time an image is submitted. Try again and it should work. If not, let the webmaster know!</h4>
                </div>
            </div>
...
var BackgroundimageOptionsForm = React.createClass ({
    ...
    <div className="container-fluid" style={modalstyle}>
        ...
        <p>Note: background images are cropped to a 16:10 aspect ratio. On many screens (i.e., a standard HD screen with a 16:9 aspect ratio), portions of the image may not be visible--so crop your image accordingly! To help you get the best display for images that have important content on certain edges of the image, you can decide how to center a background image (horizontal left/center/right, vertical top/center/bottom) when you assign it to a section of a project.</p>
            <BackgroundimageAdjustPanel data={this.state.data} aspectratio={this.props.aspectratio} src={this.props.src} adjustpercentage={this.state.adjustpercentage} zoomeddimensions={this.state.zoomeddimensions} ref={this.containerResize}/>
        </div>
        ...
        <div className="container-fluid" style={clearbuttonstyle}><a className="btn btn-warning" onClick={this.clearBannerAdjust}>Clear + hide banner adjustment menu</a></div>
...
var BackgroundimageAdjustPanel = React.createClass ({
        ...
        return (
            <div style={containerStyle} id="padding-div">
                <div style={dragcontainerstyle} id="drag-container">
                        ...
                        <BackgroundimageDragDiv src={this.props.src} zoomeddimensions={this.props.zoomeddimensions} adjustpercentage={this.props.adjustpercentage} />
                    </div>
                </div>
            </div>
        );
...
var BackgroundimageDragDiv = React.createClass({
