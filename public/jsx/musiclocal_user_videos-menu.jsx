var VideosMenu = React.createClass({
    ...
    getInitialState: function(){
        return {links: [
            {name: 'Manage', reactnodetomount: 'VideoContainer', mountlocation: 'content-main', active: false},
            {name: 'Create', reactnodetomount: 'VideoCreateContainer', mountlocation: 'content-main', active: false}
        ]};
    },
    ...
    onLinkClick: function(data){
        ...
        if (data == 'VideoContainer'){
            ReactDOM.render(<VideoContainer/>, document.getElementById('content-main'));
        }
        else if (data == 'VideoCreateContainer'){
            ReactDOM.render(<VideoCreateContainer/>, document.getElementById('content-main'));
        }
    },
    ...
    render: function(){
        var links = this.state.links.map(function(link){
            return <VideosMenuLink name={link.name} reactnodetomount={link.reactnodetomount} onLinkClick={this.onLinkClick}/>
        }.bind(this));
