...
var BookinglistingContainer = React.createClass({
    displayName: "BookinglistingContainer",
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                null,
                React.createElement(BookinglistingList, { data: this.state.data, handleDeleteButton: this.handleDeleteButton })
            )
        );
    }
});
...
var BookinglistingList = React.createClass({
    displayName: "BookinglistingList",
...
var CurrentBookinglisting = React.createClass({
    displayName: "CurrentBookinglisting",
    ...
    onClick: function onClick() {
        ...
        return;
        React.unmountComponentAtNode(document.getElementById('content-modal'));
        React.render(React.createElement(BookinglistingModal, { bookinglisting_title: this.props.bookinglisting_title, bookinglisting_content: this.props.bookinglisting_content, bookinglisting_id: this.props.bookinglisting_id, key: 'modal' + this.props.bookinglisting_id, handleDeleteButton: this.handleModalDeleteButton }), document.getElementById('content-modal'));
        $('#content-main').hide();
...
var BookinglistingModal = React.createClass({
    displayName: "BookinglistingModal",
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "a",
                { id: "deletecurrentlistingbutton", className: "btn btn-default", onClick: this.handleDeleteButton },
                "Delete Listing"
            ),
