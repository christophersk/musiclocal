    ...
    var CurrentAlbum = React.createClass({
        ...
        render: function render() {
            ...
            var albumphotos = this.state.filenames.map(function (albumphoto) {
                return React.createElement(AlbumPhoto, { filename: albumphoto.filename, key: albumphoto.filename, id: albumphoto.facebookphoto_id, photoalbumid: albumphoto.photoalbum_id, onBannerAddClick: this.handleIntermediate });
            });
