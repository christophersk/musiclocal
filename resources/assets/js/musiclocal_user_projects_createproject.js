...
var CreateProjectContainer = React.createClass({
    ...
    submitCreateNewProject: function submitCreateNewProject() {
        ...
        $.ajax({
            ...
            success: (function (response) {
                ...
                //React.render(<SocialAddContainer url=""/>, document.getElementById('manageprojectcontent'));
                location.reload();
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "label",
                        { className: "col-sm-3 control-label", htmlFor: "projectnametextinput" },
                        "Project Name:"
                    ),
                    React.createElement(
                        "div",
                        { className: "col-sm-9" },
                        React.createElement("input", { type: "text", id: "projectnametextinput", className: "form-control", value: projectnamedefaulttext, onChange: this.handleProjectNameTextEntry })
                    )
                ),
                React.createElement(
                    "div",
                    ...
                    React.createElement(
                        "label",
                        { className: "col-sm-3 control-label", htmlFor: "projecturltextinput" },
                        "Project URL:"
                    ),
                    React.createElement(
                        "div",
                        { className: "col-sm-9" },
                        React.createElement("input", { type: "text", id: "projecturltextinput", className: "form-control", value: projecturldefaulttext, onChange: this.handleProjectURLTextEntry })
                    )
                ),
                React.createElement(
                    "div",
