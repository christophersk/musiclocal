...
<div class="container-fluid contentcolor" style="padding-left:0px;padding-right:0px;background-color:transparent;">
        ...
        <div class="col-sm-12">-->
            ...
            <!--<div class="row outershadow" style="padding:5px; padding-bottom:0px; box-sizing:border-box; max-width:3840px;">--> <!--data-spy="affix" data-offset-top="420" id="affixedbanner"-->
                <div class="" style="padding:0px;padding-bottom:0px;background-color:transparent;">
                    <div id="carousel-header" class="carousel slide" data-ride="carousel" data-interval="12000" style="background-color:transparent;">
                        <!-- Indicators -->
...
<?php
                            ...
                            foreach ($projectbannerimages as $projectbannerimage) {
                                if ($i == 0) {
                                    if ($projectbannerimage->pivot->bannerheadline_id == null){
                                    $bannerheadline = '';
                                    $bannerheadline_h1 = '';
                                    $bannerheadline_h2 = '';
                                    $bannerheadline_h3 = '';
                                    ...
                                    echo '<div class="item active" style="background-color:transparent;">
                                        <div style="" id="img-' . md5($projectbannerimage->bannerimage_uniqueid) . '"></div>
                                        <noscript>
                                            <div style="display:inline;position:relative;" id="noscript-img-' . md5($projectbannerimage->bannerimage_uniqueid) . '">
                                        ...
                                        <script>
                                            $(\'#img-' . md5($projectbannerimage->bannerimage_uniqueid) . '\').html(\'<div style="background-color:transparent;position:absolute;left:50%;top:0%;width:100%;height:100%"><div class="header_text_container" style="position:relative;left:-50%;"><h1 class="' . $bannerheadline_h1_style . '">' . $bannerheadline_h1 . '</h1><h2 class="' . $bannerheadline_h2_style . '">' . $bannerheadline_h2 . '</h2><a href="' . $bannerheadline_h3link . '"><h3 class="' . $bannerheadline_h3_style . '">' . $bannerheadline_h3 . '</h3></a></div></div><div class="bannerslidecontainer"><img class="img img-responsive bannerslide" id="xsimg-' . md5($projectbannerimage->bannerimage_uniqueid) . '" src="//d1y0bevpkkhybk.cloudfront.net/t/' . md5($projectbannerimage->bannerimage_uniqueid) . '.jpg"></div></div>\');
                                    ...
                                    echo'<div class="item" style="background-color:transparent;">
                                    <div style="" id="img-' . md5($projectbannerimage->bannerimage_uniqueid) . '"></div>
                                        <noscript>
                                            <div style="display:inline;position:relative;" id="noscript-img-' . md5($projectbannerimage->bannerimage_uniqueid) . '">
                                                    <img class="img img-responsive bannerslide" id="xsimg-' . md5($projectbannerimage->bannerimage_uniqueid) . '" src="//d1y0bevpkkhybk.cloudfront.net/c/' . md5($projectbannerimage->bannerimage_uniqueid) . '.jpg">
                                        ...
                                        <script>
                                            $(\'#img-' . md5($projectbannerimage->bannerimage_uniqueid) . '\').html(\'<div style="background-color:transparent;position:absolute;left:50%;top:0%;width:100%;height:100%"><div class="header_text_container" style="position:relative;left:-50%;"><h1 class="' . $bannerheadline_h1_style . '">' . $bannerheadline_h1 . '</h1><h2 class="' . $bannerheadline_h2_style . '">' . $bannerheadline_h2 . '</h2><a href="' . $bannerheadline_h3link . '"><h3 class="' . $bannerheadline_h3_style . '">' . $bannerheadline_h3 . '</h3></a></div></div><div class="bannerslidecontainer"><img class="img img-responsive bannerslide" id="xsimg-' . md5($projectbannerimage->bannerimage_uniqueid) . '"></div></div>\');
