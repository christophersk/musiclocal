...
<script>
    console.log('<?php if (isset($backgroundimage_audio)) { echo $backgroundimage_audio->backgroundimage_uniqueid; } ?>')
</script>
<script>
...
<div id="lessons"></div>
@if ($project->projectsettings->lessons_active == 1 and $project->project_url == 'chrisskene')
@include ('includes.project_lessons')
@endif
