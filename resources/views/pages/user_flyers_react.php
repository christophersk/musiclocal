...
var DragDiv = React.createClass({
    ...
    componentDidMount: function() {
        ...
        ctx.drawImage(thephoto,0,0);
        }, false);

        thephoto.src = 'https://scontent.xx.fbcdn.net/hphotos-xfa1/v/t1.0-9/11223602_508657405953532_3730760810896883121_n.jpg?oh=14ff6906b40b87fbc9588c9de7516771&oe=5651A5D4';
    ...
    console.log('pre-render dragdiv width is ' + this.props.zoomeddimensions.zoomedwidth);
        ...
        var canvasstyle = {display:'inline-block'};
        return (
            <div id="drag" style={dragdivstyle} onTouchEnd={this.handleTouchEnd}>
            <canvas id="dragcanvas" style={canvasstyle}></canvas>
