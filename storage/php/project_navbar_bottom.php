...
*/
    ...
    $nav_bottom = <<<EOD
<div class="navbar navbar-inverse navbar-fixed-bottom" role="navigation" style="background-color:transparent;border-style:none;">
      <div class="container-fluid nopadding">
        ...
        <div class="collapse navbar-collapse">
          ...
          <div class="userfullnamecontainer">
          <!--<ul class="nav navbar-nav navbar-left" style="background-color:#222;border-top-right-radius:6px;">
          ...
          <ul class="nav navbar-nav navbar-right" style="background-color:#222;border-top-left-radius:6px;">
            <li class="locationcontainer"><a href="$locurl">$locname</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    $(document).ready(function(){
        ...
        if (w < 768) {
            ...
            $('#top-navbar-container-fixed').css({'background-color': 'rgba(0,0,0,0)', 'border-color': 'rgba(0,0,0,0)', 'margin-bottom': '0px'});
         ...
         type: "GET",
            ...
            success: (function (response) {
                if (response == 0) {
                    ...
                    $(".userfullnamecontainer").html('<ul class="nav navbar-nav navbar-left" style="background-color:#222;border-top-right-radius:6px;"><li class="active"><a href="$user_home" class="userfullnamecontainer" onclick="$(".collapse").collapse("hide")"><span>Logged in as ' + parsedresponse.user_first_name + ' ' + parsedresponse.user_last_name + '.</span></a></li></ul>');
